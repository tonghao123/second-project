...
@section('amodel_main')
    ...
    <div style="width:100%;height:100%;">
        <div style="width:400px;margin:20px auto 10px;border-radius: 3px;padding:15px;box-shadow: 1px 1px 3px 1px #dedede;text-align:center">
            <h3><span class="glyphicon glyphicon-picture"></span>修改权限</h3>
            <form action="" method="post" >

                <div class="form-group">
                    <label for="exampleInputEmail1">权限路由</label>
                    <input type="text" class="form-control" placeholder="" name="name" value="{{$alters->name}}">
                </div>
                <div class="form-group">
                    <label for="exampleInputPassword1">权限名称</label>
                    <input type="text" class="form-control" placeholder="" name="display_name" value="{{$alters->display_name}}">
                </div>
                <div class="form-group">
                    <label for="exampleInputPassword1">描述</label>
                    <textarea class="form-control" rows="3" name="description" >{{$alters->description}}</textarea>
                </div>
