...
@section('amodel_main')
    <div class="amodel_mainfirst">
        <span> <span class="glyphicon glyphicon-home"></span><a href="{{asset('admin/index')}}">首页</a> &nbsp;>>&nbsp; <a href="{{asset('/admin/birth-list')}}">生日管理</a> &nbsp;>>&nbsp; <a href="{{asset('/admin/birth-show')}}">最近生日</a> </span>
    </div>
            ...
            <tr>
                ...
                <td>
                    @if($firendbirth->avatar != 'Home/img/default.jpg')
                        <img src="{{url('img/home/'.$firendbirth->avatar.'.jpg')}}" style="width: 68px;height: 68px;">
                    @else
                        <img src="{{url($firendbirth->avatar)}}" style="width: 68px;height: 68px;">
                    @endif
                </td>
