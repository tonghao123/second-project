...
@section('main')
    @if(count($errors))
        <div>
        <ul class="alert alert-danger" style="width:860px;padding:10px 0;outline:none;height:40px;margin:20px auto 10px;!important;">
            <ul>
