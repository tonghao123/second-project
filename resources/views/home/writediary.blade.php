            ...
            <div id="addBlog_editorWrap">
                ...
                <div class="mceLayout">
                    ...
                    <div id="word">
                        ...
                        <textarea id="diary_hidden" name="content" style="display: none;"></textarea>
                        <input type="hidden" name="id" value="{{Auth::user()->id}}">
                    </div>
                </div>
            </div>
            <div id="addBlog_editorButtons">
                <a  href="" type="button" id="cancel" class="btn btn-default" value="">取消</a>
...
<div class="diary_brow" >
    ...
    <div class="diary_brow2">
        <ul>
           @for($i=1;$i<72;$i++)
            <li><img src="{{asset('home/img/rr_brow/'.$i.'.gif')}}" width="20" height="20"></li>
               @endfor
        </ul>
    </div>
</div>
