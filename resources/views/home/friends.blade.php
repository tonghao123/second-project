    ...
    <div class="friends_out">
        ...
        <div class="friends_info_all" >
            ...
            <div class="friends_info">
                ...
                <a href="{{asset('/home/delfriends/'.$ar['id'])}}" class="btn btn-default  btn-sm" style="width: 130px;text-align: center">删除好友</a>
            </div>
            {{--一个好友stop--}}
            ...
            <div class="friends_small">
                <div class="friends_smallpic">
                    ...
                    <a  href="{{asset('/home/delfriends/'.$ar['id'])}}" ><button class="btn btn-default  btn-sm" >删除好友</button></a>
                </div>
            </div>
             {{--一个小框的好友stop --}}
            @endforeach
